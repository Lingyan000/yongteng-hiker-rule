...
规则接口来源于「夸克」 APP 的「夸克壁纸」<br/>
若是你喜欢「夸克壁纸」，请前往应用商店下载「夸克」获得更好的使用体验。<br/>
<br/>
...
export function disclaimer(): HomeRuleItem[] {
  ...
  items.push({
    ...
    col_type: "text_2",
    url:
      "hiker://empty@lazyRule=.js:writeFile('hiker://files/QuarkPic/.disclaimer','1');refreshPage();'toast://已同意'",
  });
  return items;
}

export function isAgree(): boolean {
  let res = hiker_fetch("hiker://files/QuarkPic/.disclaimer", {});
  return res == "1";
}
