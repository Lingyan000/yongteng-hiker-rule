...
规则接口来源于「酷安」 APP 的「酷图」<br/>
若是你喜欢「酷图」，请前往应用商店下载「酷安」获得更好的使用体验。<br/>
<br/>
...
export function disclaimer(): HomeRuleItem[] {
  ...
  items.push({
    ...
    col_type: "text_2",
    url:
      "hiker://empty@lazyRule=.js:writeFile('hiker://files/CoolPic/.disclaimer','1');refreshPage();'toast://已同意'",
  });
  return items;
}

export function isAgree(): boolean {
  let res = hiker_fetch("hiker://files/CoolPic/.disclaimer", {});
  return res == "1";
}
